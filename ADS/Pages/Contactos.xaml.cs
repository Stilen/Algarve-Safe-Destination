    ...
    public sealed partial class Contactos : Page
    {
        ...
        private async void ZoomToEnt(Classes.Entidade ent)
        {
            ...
            if (ent.dest)
            {
                ...
                this.current = new Geopoint(new BasicGeoposition() { Latitude = location.Coordinate.Point.Position.Latitude, Longitude = location.Coordinate.Point.Position.Longitude });
                ent.dest = false;
                Plan_Route(ent);
            }
        }
       ...
       private async void ZoomCurrentLoc()
       {
           ...
           try
           {
               ...
               Geoposition location = MainPage.instance.getPos();
               this.current = new Geopoint(new BasicGeoposition() { Latitude = location.Coordinate.Point.Position.Latitude, Longitude = location.Coordinate.Point.Position.Latitude });
           ...
           catch
           {
               ...
               await map1.TrySetViewAsync(temp, 8, 0, 0, MapAnimationKind.None);
           }
       }
