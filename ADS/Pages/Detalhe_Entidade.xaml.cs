...
namespace ADS.Pages
{
    ...
    public sealed partial class Detalhe_Entidade : Page
    {
        ...
        {
            //Old method to set destination, not working
            //ent.dest = true;
            //Frame.Navigate(typeof(Pages.Contactos), ent);

            DatabaseHelperClass dbtemas = new DatabaseHelperClass();
            string latitude = dbtemas.latitude(ent.N_Vertice).ToString();
            string longitude = dbtemas.longitude(ent.N_Vertice).ToString();
