...
namespace ADS.Pages
{
    ...
    public sealed partial class Definicoes : Page
    {
        ...
        private void DBAutoUpdateSwitch_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            if (toggleSwitch != null)
            {
                ...
                {
                    obj.DBAutoUpdate = true;
                }
                else
                {
                    obj.DBAutoUpdate = false;
                }
            }
        }
        ...
        private void Translate()
        {
            ...
            DBAutoUpdateSwitch.Header = dbhandle.Translate(DBAutoUpdateSwitch.Header.ToString());
            DBAutoUpdateSwitch.OnContent = dbhandle.Translate(DBAutoUpdateSwitch.OnContent.ToString());
            DBAutoUpdateSwitch.OffContent = dbhandle.Translate(DBAutoUpdateSwitch.OffContent.ToString());
